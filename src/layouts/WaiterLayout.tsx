...
import { UtensilsCrossed, ClipboardList, LayoutGrid, LogOut } from "lucide-react";
...
const waiterNavItems: NavItem[] = [
  { title: "Menu", href: "/waiter", icon: UtensilsCrossed },
  { title: "Orders", href: "/waiter/orders", icon: ClipboardList },
  { title: "Tables", href: "/waiter/tables", icon: LayoutGrid },
];
...
export function WaiterLayout() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      {/* Bottom Navigation */}
      <BottomNav items={waiterNavItems} />
    </div>
  );
}
